...
topDownBlackGradientSpan =
    div [ class "relatove top-0 h-[20%] w-full bg-gradient-to-b from-black to-black/0 z-10" ] []
...
navbar model =
    div [ id "navbar", class "fixed top-0 left-0 w-full h-18 z-[1000]" ]
        [ div [ class "h-16 bg-black text-white flex items-center justify-center" ]
...
bioPanel model =
    div [ class "flex flex-col pt-26 pb-16 lg:px-16 xl:px-32" ] -- Added padding for smaller screens
...
--                     []
--               ]
--         , div [ class "absolute bottom-0 h-[2%] w-full bg-gradient-to-t from-black to-black/0" ] []
--         ]
